        ...
        while(true){
            ...
            switch (choice){
                case 1:
                    ...
                    sql.insert((lst.get(lst.size()-1)).getUserEncryptedPassword(),(lst.get(lst.size()-1)).getUserSalt(),lst.get(lst.size()-1).getUserName());
                    break;
                case 2:
//                    sql.viewAll();
                ...
                case 3:
                    ...
                    sql.delete(lst.get(choiceTemp-1).getUserName());
